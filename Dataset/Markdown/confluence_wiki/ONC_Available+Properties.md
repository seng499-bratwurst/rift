...
# Description: The propertyCode values can be used as a filter on the locations, devices, deviceCategories, properties, dataProducts and dataProductDelivery services. Filters on the propertyCode, propertyName and description columns can be used to reduce the results returned from the properties service.
